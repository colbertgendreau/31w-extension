(function () {
  ...
  let elmCarrousel__fleche__prev = document.querySelector(
    ".elmCarrousel__fleche__prev"
  );
  let elmCarrousel__fleche__next = document.querySelector(
    ".elmCarrousel__fleche__next"
  );
